...
def test_cpu_offload_forces_both_stacks_to_stream(monkeypatch, cpu_offload, expected):
    ...
    low VRAM still got the 29 GiB global stack pinned.
    """
    from remove_ai_watermarks.noai import qwen_zimage_pipeline as pipeline_module
    from remove_ai_watermarks.noai import watermark_remover as module
